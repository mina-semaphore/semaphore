...
<p align="center">
    ...
    <a href="https://www.npmjs.com/package/@mina-semaphore/contracts">
        <img alt="NPM version" src="https://img.shields.io/npm/v/@mina-semaphore/contracts?style=flat-square" />
    </a>
    <a href="https://npmjs.org/package/@mina-semaphore/contracts">
        <img alt="Downloads" src="https://img.shields.io/npm/dm/@mina-semaphore/contracts.svg?style=flat-square" />
    </a>
</p>
...
Install the `@mina-semaphore/contracts` package with npm:

```bash
npm i @mina-semaphore/contracts
```

or yarn:

```bash
yarn add @mina-semaphore/contracts
```
